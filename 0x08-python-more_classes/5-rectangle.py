...
class Rectangle:
    ...
    - __repr__(self): Returns a string representation of the rectangle to be

    - __del__(self): Prints the message "Bye rectangle..." when an instance
    ...
    def __str__(self):
        """Return a string reprentaion of the rectangle with '#' characters."""
        if self.__width == 0 or self.__height == 0:
            return ""
        rectangle_str = ""
